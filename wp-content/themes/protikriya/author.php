	...
	<div class='col-md-8 maincontent toppad'>
		...
		<div class='row author-pad'>
			...
			<ul class="nav nav-tabs" role="tablist">
				<li ><a href="#posts" role="tab" data-toggle="tab">Articles</a></li>
			  	<li><a href="#questions-a" role="tab" data-toggle="tab">Questions</a></li>
			...
			<div class="tab-content">
  				...
  				<div class="tab-pane" id="comments-a"> <!-- User Comments -->
					...
					<?php
        				...
        				if($comments){
            				foreach ($comments as $c){
            					$output.= '<div class="row bm"><div class="span5"><div class="reddit-post pull-left"><p class="title"><a href="'.get_comment_link( $c->comment_ID ).'">';
            				...
            				echo "Nothing yet. Take part in a discussion and your comments will show up here.";
        				}
					?>
						...
						<div class = 'span3'>
							...
							<div class = 'span5'>
								...
								<div class = 'reddit-post pull-left'>
									...
									<?php if($post->post_type == 'post'){ $out = get_post_meta($post->ID, 'outbound', true); ?>
									
										<p class = 'title'>
											<a href="<?php echo $out; ?>" title="<?php the_title_attribute(); ?>" target="_blank"><?php the_title(); ?></a>
										</p>
									...
									<span class = 'tagline'>submitted <?php echo human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ago'; ?> by <?php the_author_posts_link(); ?> in <?php $category = get_the_category(); 
										if($category[0]){
			...
			<?php } ?>
					...
					<div class = 'span5'>
						...
						<?php if($post->post_type == 'post'){
						 ...
						 ?>
						<p class = 'title'><a href="<?php echo $out; ?>" title="<?php the_title_attribute(); ?>" target="_blank"><?php the_title(); ?></a></p>
						<?php }else{ ?>
						<p class = 'title'><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" target="_blank"><?php the_title(); ?></a></p>
						<?php } ?>
				<span class = 'tagline'><?php echo human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ago'; ?> by <?php the_author_posts_link();    
