...
function validateURL(textval) {
 ...
 $('#submit-question-btn2').click( function (e) {
        e.preventDefault();
          if(again > 0){
          $('.toosoon2').html('Sorry you are doing this too much. Try again in ' + again + ' seconds');
          return false;
          }
        $(this).attr( 'value', 'Working...');

    var data = $('#submit-question-form2').serialize() + "&action=epicred_submit";
    ...
    request.fail(function(jqXHR, textStatus) {
      alert( "Request failed: " + textStatus );
        ...
        setTimeout( function() {
            $('#submit-article-btn2, #submit-question-btn2').attr( 'value', 'Submit');
        }, 5000);
    });
 ...
 $('#submit-question-btn').click( function (e) {
  ...
  $('#submit-article-btn2').click( function (e) {
      e.preventDefault();
        if(again > 0){
          $('.toosoon2').html('Sorry you are doing this too much. Try again in ' + again + ' seconds');
          return false;
        ...
        $(this).attr( 'value', 'Working...');
        //lets make it AJAX
    var data = $('#submit-article-form2').serialize() + "&action=epicred_submit";

    var form = $( "#submit-article-form2" );
    form.validate();
    if(form.valid()){
