...
function remove_admin_menu_items(){
  if (!current_user_can('administrator') && !is_admin()){
    $remove_menu_items = array(__('Comments'),__('Questions'),__('Tools'),__('All Posts'), __('Jetpack'));
    global $menu;
    end ($menu);
    while (prev($menu)){
...
function my_login_logo() { ?>
    <style type="text/css">
        #login h1 a, .login h1 a {
            background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/protikriya.png) !important;
            padding-bottom: 30px;
        }
    </style>
<?php }
...
function my_frontend_script(){
  wp_enqueue_script( 'my_script', get_template_directory_uri() . '/js/ajax.js', array( 'jquery' ), '1.0.0', true );
}
  ...
  <ul id="utils-list">
    ...
    <li>
      <a class="dropdown-toggle utility-dropdown dark-grey small" id="cat-drop" role="button" data-toggle="dropdown" href="#">
        <?php 
          if(is_category()){ single_cat_title('Category: '); }
          else{ echo 'Topic: All'; } 
        ?>
        <b class="caret"></b>
      </a>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="submit-article">
          <form id="submit-article-form" method="post" action="#" class="clearfix">
            <label>URL</label>
            <input type="url" class="form-control" name="content" id="out" placeholder="for example http://protikriya.com" value="" required="">
            <label>Title</label>
        ...
        <div class="tab-pane" id="submit-question">
          <form id="submit-question-form" method="post" action="#" class="clearfix">
            ...
            <textarea id="question-text" name="title" placeholder="The question..." wrap="soft" required=""></textarea>
            <input type="hidden" name="content" value="">
            <div style="clear:both"></div>
            <label>Topic</label>
            <?php wp_dropdown_categories($args); ?>
            <label>Question Details <span class="tiny">(optional)</span></label>
            <textarea id="question-details-input" name="new_post_details" placeholder="Add any additional details here." wrap="soft"></textarea>
    ...
    <a href="/" title="Cancel" class="lt-grey" id="icon-cancel-submit"><i class="icon-remove icon-large"></i> Cancel</a>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="submit-article2">
          <form id="submit-article-form2" method="post" action="#" class="clearfix">
            <label>Title</label>
            ...
            <label>Article Summary <span class="tiny">(optional)</span></label>
            <textarea id="article-details-input" name="new_post_details" placeholder="Optionally, add a summary of the post here." wrap="soft"></textarea>
            <input type="hidden" name="_wpnonce" value="91dee83183"><input type="hidden" name="_wp_http_referer" value="/">            <input id="submit-article-btn2" class="btn btn-primary pull-left" name="submit-article-form" type="submit" value="Submit">
            <div style="clear:both"></div>
            <br>
            <div class='toosoon'></div>
          </form>
        ...
        <div class="tab-pane" id="submit-question2">
          <form id="submit-question-form2" method="post" action="#" class="clearfix">
            <label>Question</label>
            ...
            <input type="hidden" name="save" value="1">
            <div style="clear:both"></div>
            <input type="hidden" id="_wpnonce"  value="91dee83183"><input type="hidden" name="_wp_http_referer" value="/">            <input id="submit-question-btn2" class="btn btn-primary pull-left" name="submit-question-form" type="submit" value="Submit">
            <div style="clear:both"></div>
            <br>
      ...
      <li>
        ...
        <?php }else{ ?>
          <a id="sidebar-submit" href="/submit-articles" title="Submit Article" class="toggle-submenu">
            ...
            <span class="icontext">New</span>
          </a>
          <!--<a href="http://protikriya.com/wp-admin/post-new.php" title="New Blog Post">
            <i class="fa fa-plus-circle fa-2x"></i>
            <span class="icontext">Journal</span>
          </a>-->
        ...
        <div class="fb-like social" 
        data-href="https://www.facebook.com/protikriya.bangladesh/" 
        ...
        <!--<a href="https://twitter.com/ashpriom" class="twitter-follow-button" data-show-count="false">Follow</a>
 ...
 * arrays. This function is hooked into tgmpa_init, which is fired within the
