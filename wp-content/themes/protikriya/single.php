...
<div class="alert alert-info alert-dismissible toppad2 submsgcons" role="alert">
  ...
  <strong>Done.</strong> View your post below:<span class='submsg'></span>.
</div>
<?php 
			...
			<div style="clear:both"></div>
				...
				<div class="commentbox">
					...
					<script>(function(d, s, id) {
					  ...
					  js.src = "//connect.facebook.net/bn_IN/sdk.js#xfbml=1&version=v2.7&appId=303330846490638";
					  fjs.parentNode.insertBefore(js, fjs);
					}(document, 'script', 'facebook-jssdk'));</script>

					<div class="fb-comments" data-numposts="7"></div>
